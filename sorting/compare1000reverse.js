...
test.dataStore.reverse();

console.log("5000 num ordinati al contrario - bubble sort:  ", testAlgoritmoDaArray("bubbleSortMia", 40, test.dataStore))
console.log("5000 num ordinati al contrario - selection sort:  ", testAlgoritmoDaArray("selectionSort", 40, test.dataStore))
console.log("5000 num ordinati al contrario - insertion sort:  ", testAlgoritmoDaArray("insertionSort", 40, test.dataStore))
console.log("5000 num ordinati al contrario - shell sort:  ", testAlgoritmoDaArray("shellsortDyn", 40, test.dataStore))
console.log("5000 num ordinati al contrario - merge sort:  ", testAlgoritmoDaArray("mergeSort", 40, test.dataStore))
console.log("5000 num ordinati al contrario - quick sort:  ", testAlgoritmoDaArray("quickSort", 40, test.dataStore))

/*

facendo quest' altro test risulta che per 5000 elementi ordinati al contrario le velocità sono:

1 posto - shell sort       (velocità media: circa 0.475 ms)
2 posto - merge sort       (velocità media: circa 1.525 ms)
3 posto - insertion sort   (velocità media: circa 19.925 ms)
4 posto - selection sort   (velocità media: circa 21.925 ms)
5 posto - bubble sort      (velocità media: circa 28.075 ms)
6 posto - quick sort       (velocità media: circa 372.375 ms !!!???)
